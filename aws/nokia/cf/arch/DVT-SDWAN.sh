...
#aws cloudformation create-stack --region eu-west-2 --capabilities CAPABILITY_NAMED_IAM  --stack-name DvtSdwanVpcLon --template-body file://DVT-VPCandSubnets.yaml --parameters https://s3.eu-west-2.amazonaws.com/btdyns-cf-templates/DVT-VPCandSubnets_param.json
