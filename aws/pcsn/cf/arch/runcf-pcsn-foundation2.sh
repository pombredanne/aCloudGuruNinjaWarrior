...
aws cloudformation create-stack  --role-arn iarn:aws:iam::813970735459:role/pcsn-iam-role --region eu-west-2 --stack-name testpcsnFoundation --template-body file://pcsn_cft_foundation.yml \
--parameters \
ParameterKey=NetworkVPCID,ParameterValue='vpc-8baebde2' \
ParameterKey=NetworkAddressRange,ParameterValue='10.0.98' \
